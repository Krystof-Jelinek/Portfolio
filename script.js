...
const translations = {
    ...
    cz: {
        ...
        aboutText: "Jmenuji se Kryštof Jelínek a v současnosti jsem ve třetím ročníku studia na Fakultě informačních technologií Českého vysokého učení technického v Praze, kde studuji obor softwarové inženýrství. Moje portfolio se primárně zaměřuje na projekty vyvinuté v jazycích Java, C++, Kotlin a Scala, dále také i na práci s databázemi a konceptuálním modelováním. Tyto projekty jsou nedílnou součástí mého akademického studia a odrážejí mé osobní zájmy. Plánuji absolvovat v roce 2026 a v současnosti aktivně hledám pracovní příležitosti, které mi nabídnou praktické zkušenosti v oblasti softwarového inženýrství, stejně jako podporu při vypracování bakalářské práce. Vždy se těším na nové výzvy, které mi umožní růst a rozvíjet mé dovednosti (nejen) v oblasti vývoje softwaru.",
        ...
        asciiLong1: "V rámci svých studií jsem vyvinul modulární, vysoce škálovatelnou aplikaci v jazyce Scala, navrženou s důrazem na architekturu a rozšiřitelnost. Design systému využívá objektově orientované principy k vytvoření flexibilního a udržitelného kódu, který snadno umožňuje budoucí změny a přidávání nových funkcí.",
        asciiLong2: "Plynulý chod aplikace je do značné míry zajištěn její modulární strukturou, která umožňuje bezproblémovou integraci různých formátů obrázků a metod konverze, aniž by došlo k narušení celkového systému. Design usnadňuje jednoduché přidávání nových filtrů a funkcí, což zajišťuje, že aplikace může růst a vyvíjet se podle potřeb uživatelů.",
        asciiLong3: "Byl integrován robustní a flexibilní systém pro zpracování příkazů, který odděluje logiku od interakce s uživatelem, čímž zlepšuje údržbu i uživatelskou zkušenost. Architektura aplikace upřednostňuje znovupoužitelnost a jednoduchost, což zajišťuje, že každý komponent je nezávislý a znovu použitelný v jiných projektech nebo scénářích.",
        asciiLong4: "Tento designově orientovaný přístup zajišťuje, že systém zůstává snadno škálovatelný, modifikovatelný a udržovatelný, čímž vytváří pevný základ pro dlouhodobé použití a podporuje efektivní vývojové praktiky.",
        asciiLong5: "Zde je příklad aplikace v akci. Můžete si klonovat repozitář a prozkoumat plnou funkčnost na vlastní oči.",
        asciiLong6: "Prozkoumejte projekt na GitHubu:",

        akrmatShort: "Aplikace vyvinutá týmem pro generování akreditačních materiálů na Fakultě informačních technologií, která zjednodušuje akreditační proces díky integraci dat z externích API a využívá LaTeX pro efektivní tvorbu PDF dokumentů.",
        akrmatLong1: "Akrmat je týmový projekt vyvinutý na Fakultě informačních technologií. Cílem aplikace je zjednodušit proces generování akreditačních materiálů, jako jsou studijní plány a programy, přičemž LaTeX je využíván k vytváření profesionálních PDF dokumentů pro akademické účely.",
        akrmatLong2: "Můj hlavní příspěvek spočíval v vývoji samostatné mikroservisy, která kompiluje LaTeX kód do PDF. Tento servis je integrován do systému Akrmat, přijímá LaTeX kód prostřednictvím API, zpracovává ho a vrací vygenerovaný PDF. Také jsem měl na starosti úpravy, rozšiřování, ladění a řešení problémů s generováním LaTeX dokumentů, aby bylo zajištěno, že splňují požadované standardy.",
        akrmatLong3: "LaTeX byl pro mě zcela nový, a práce s ním byla cennou výzvou. LaTeX kód v Akrmat je generován dynamicky, přičemž využívá vstupy z různých částí systému k vytváření přesných akreditačních dokumentů. Oddělením generování PDF do samostatné služby jsme zajistili čistou, modulární architekturu, která umožňuje snadnou údržbu a rozšíření.",
        akrmatLong4: "Tento projekt byla skvělá příležitost pracovat s externími API a získat zkušenosti s generováním dokumentů na bázi LaTeX, zároveň jsem si vylepšil dovednosti v týmové práci a řešení problémů.",
        akrmatLong5: "Vezměte prosím na vědomí, že tento projekt je interní aplikace používaná na Fakultě informačních technologií, a proto nemohu poskytnout zdrojový kód ani podrobnosti. Pokud máte zájem o více informací o tomto konkrétním projektu, neváhejte mě kontaktovat a rád vám poskytnu další informace.",

        carShort: "Aplikace v Spring Bootu v jazyce Java s REST API, integrací ORM a databáze Azure. Vytvořeno během 3. semestru, obsahující plné CRUD operace a vlastní implementaci front-endu. Navrženo s třístupňovou architekturou, která zajišťuje jasné oddělení jednotlivých vrstev.",
        carLong1: "Tento projekt je robustní, třívrstvá Java aplikace postavená na Spring Bootu, navržená pro správu operací s půjčováním aut, s integrací do databáze Azure. Aplikace implementuje čistou, modulární architekturu s jasným oddělením jednotlivých vrstev, což zajišťuje udržitelnost a škálovatelnost.",
        ...
        carLong4: "Aplikace také využívá Gradle jako nástroj pro automatizaci buildů, což zajišťuje efektivní vývojový proces. Plně nakonfigurované Dockerfile pro backend i frontend jsou součástí projektu, což usnadňuje nasazení a spuštění aplikace v jakémkoli prostředí. Pro testování projekt používá Mockito pro mockování závislostí a zajištění spolehlivosti jednotlivých komponent.",
        ...
        excelShort: "Tento projekt implementuje engine pro zpracovatel tabulek, který simuluje chování tabulky (např. v Excelu nebo Google Sheets) pomocí objektově orientovaného přístupu v C++. Klíčovým prvkem řešení je použití dědičnosti a polymorfismu.",
        excelLong1: "Tento projekt implementuje výkonný engine pro zpracovatel tabulek, který simuluje chování tabulky podobně jako nástroje jako Excel nebo Google Sheets. Aplikace je postavena v C++ a zaměřuje se na přesné zpracování buněk, vzorců a detekci cyklických závislostí mezi nimi. Je navržena s objektově orientovaným přístupem, využívající dědičnost a polymorfismus k modelování různých typů buněk a operací, které je možné na nich provádět. Hlavní funkcionalita se zaměřuje na:",
        ...
        excelLong5: "Integrace externího parseru: Engine integruje externí parser pro zadávání vzorců, čímž zajišťuje plynulý a flexibilní způsob čtení a zpracování uživatelsky definovaných vzorců.",
        ...
        sqlShort: "Sada úkolů zaměřených na PLSQL a PgPLSQL, pokrývající balíčky, procedury, triggery, rekurzi a optimalizaci plánu vykonávání. Hlavní důraz je kladen na PostgreSQL, ale kolekce také zahrnuje sekce zkoumáící implementace specifické pro Oracle.",
        sqlLong1: "Tato kolekce úkolů se zaměřuje na pokročilé SQL koncepty a praktiky, s důrazem na PLSQL a PgPLSQL. Pokrývá širokou škálu témat, včetně vytváření a správy triggerů, použití I/O balíčků pro zpracování dat, optimalizace plánu vykonávání a implementace SQL rekurze pro složité dotazy na data.",
        sqlLong2: "Hlavní důraz je kladen na PostgreSQL, ale úkoly také obsahují sekce zkoumající funkce specifické pro Oracle, čímž poskytují ucelený pohled na databázové programování. Každý úkol je navržen tak, aby zlepšil praktické dovednosti a hluboké porozumění pokročilým SQL funkcionalitám.",
        sqlLong3: "Pokud byste chtěli prozkoumat celý soubor úkolů, včetně podrobných implementací a příkladů, neváhejte navštívit můj GitHub repository. Tam najdete všechny materiály a zdrojový kód.",

        komShort: "Projekt modelující doménu autoservisních služeb pomocí OntoUML, UML, BPMN a OCD diagramů. OntoUML zachycuje klíčové entity a vztahy mezi nimi, BPMN mapuje konkrétní procesy. OCD zobrazuje pracovní tok systému.",
        komLong1: "Tento projekt se zaměřuje na modelování domény autoservisních služeb pomocí různých modelovacích jazyků, včetně OntoUML, UML, BPMN a DEMO. Hlavním cílem bylo navrhnout komplexní model této domény, počínaje vytvořením OntoUML diagramu, který identifikuje klíčové entity zapojené do autoservisních služeb a definuje vztahy mezi nimi. OntoUML model zachycuje jak koncepční, tak strukturální aspekty domény a poskytuje pevný základ pro další analýzu.",
        komLong2: "Integritní omezení byla definována pomocí OCL (Object Constraint Language), aby byla zajištěna konzistence a správnost modelu. Systém automaticky kontroloval potenciální antipatterny v rámci OntoUML modelu.",
        ...
        komLong5: "Pokud máte zájem o prozkoumání kompletních detailů projektu, včetně všech diagramů a modelů, neváhejte se podívat na celé dílo.",

        cvText: "Pro podrobnější přehled mých kvalifikací, dovedností a zkušeností si prosím prohlédněte nebo stáhněte mé CV pomocí následujících odkazů:",
        cvView: "Zobrazit",
        cvDownload: "Stáhnout",
        ...
        thankYou: "Děkuji, že jste si prohlédli můj profil. Těším se na vaši odpověď a rád vám odpovím co nejdříve!"
    }
};
